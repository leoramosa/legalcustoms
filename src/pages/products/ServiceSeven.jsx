      ...
      <div className="content_service-detail">
        ...
        <div className="service_detail_content">
          <div className="service_detail">
              <ul>
              <li>Diagnostico Laboral</li>
                <li>Planeamiento Laboral</li> 
               <li>Asesoría Laboral</li>
               <li>	Patrocinio de Procesos Laborales.</li>
               <li>	Servicio de asesoramiento para extranjeros.</li>

            </ul>
            <div className="detail_request">
              Envíanos tu información : <a className="whatsapp" href={`https://api.whatsapp.com/send?phone=51936859231&text=${services[6].mensaje}${services[6].name}`}><i className="fab fa-whatsapp"></i> whatsapp </a> <a className="btn_email" href="mailto:mchavez@legalcustomsperu.com"  rel="noreferrer" target="_blank"><i className="far fa-envelope"></i> correo</a>
            </div>
